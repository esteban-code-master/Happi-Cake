...
{
    public partial class Galletas : Form
    {
        ...
        public Galletas()
        {
            ...
            string consulta= "SELECT nombre,id_producto,clase FROM producto WHERE clase='" + (int)clase.galletas + "' OR clase='" + (int)clase.cafes + "'";
